...
vi.mock("./db", () => ({
  ...
  updateLaboratoryOrder: vi.fn(async () => ({ success: true })),
  deleteLaboratoryOrder: vi.fn(async () => ({ success: true })),
  recordLaboratoryResult: vi.fn(async () => ({ success: true })),
  updateLaboratoryResult: vi.fn(async () => ({ success: true })),
  deleteLaboratoryResult: vi.fn(async () => ({ success: true })),
